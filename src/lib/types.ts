// type defs are taken from the excellent https://nimi.li/
// https://github.com/cubedhuang/sona-nimi/blob/master/src/lib/types.ts

export type UsageCategory = "core" | "widespread" | "common" | "uncommon" | "rare" | "obscure";
...
export type Language = {
	...
	credits: string;
	completeness_percent: Record<UsageCategory, `${number}`>;
};
...
export type Word = {
	 ...
	 * @example { '2022-08': '99' }
	 */
	recognition: Record<`${number}-${number}`, `${number}`> | null;
	/**

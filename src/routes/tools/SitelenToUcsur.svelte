<script lang="ts">
	...
	let result = $derived(converter(value));
</script>

<Card.Root>
	<Card.Header class="flex-row items-center space-y-0 space-x-1.5">
		<Card.Title class="me-auto" level={2}>UCSUR Converter</Card.Title>
	...
	<Card.Content class="h-full flex flex-col gap-4">
		<Textarea bind:value placeholder="tomo lipu lon seme" />

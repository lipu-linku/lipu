...
<Card
	id={word.id}
	class="
		relative flex w-auto flex-1 justify-between border-2 transition-colors
...
>
	...
	<CardContent
		class="my-auto flex items-center justify-center gap-1 px-4 py-2 text-6xl max-md:flex-col-reverse md:gap-4 md:py-0"
	>
